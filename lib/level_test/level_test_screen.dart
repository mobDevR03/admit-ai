...
class _LevelTestScreenState extends State<LevelTestScreen> {
  ...
  final List<_Question> _questions = [
    ...
    _Question(
      ...
      options: ['would have applied', 'will apply', 'would apply', 'apply']
        ..shuffle(),
      correctAnswer: 'would have applied',
    ),
    _Question(
      text:
          'Choose the correct reported speech: “I am preparing for IELTS,” she said.',
      options: [
    ...
    _Question(
      text:
          'You ____ have told me about the meeting earlier. I missed it completely.',
      options: ['should', 'must', 'can', 'may']..shuffle(),
      correctAnswer: 'should',
    ),
    _Question(
      text:
          'He ____ have stayed at home because several people saw him at the conference.',
      options: ['can’t', 'must', 'should', 'might']..shuffle(),
      correctAnswer: 'can’t',
    ),
    _Question(
      text:
          'Choose the closest meaning: “It is possible that she missed the train.”',
      options: [
    ...
    _Question(
      ...
      options: ['certain to happen', 'avoidable', 'temporary', 'unlikely']
        ..shuffle(),
    ...
    _Question(
      ...
      options: ['to improve', 'to make worse', 'to remove', 'to delay']
        ..shuffle(),
    ...
    _Question(
      text:
          'Choose the correct passive form: “They will announce the results tomorrow.”',
      options: [
    ...
    _Question(
      text:
          'Choose the best option: “Not only ____ hard, but he also managed his time well.”',
      options: ['did he study', 'he studied', 'he did study', 'studied he']
        ..shuffle(),
    ...
    _Question(
      ...
      options: ['very rarely', 'very quickly', 'every day', 'with great effort']
        ..shuffle(),
    ...
    _Question(
      text:
          'Choose the best connector: “The course is demanding; ____, it provides valuable skills.”',
  ...
  String _calculateLevel() {
    final percent = _correctAnswers / _questions.length;

    if (percent >= 0.8) return 'Advanced';
    if (percent >= 0.6) return 'Upper Intermediate';
    if (percent >= 0.4) return 'Intermediate';
    if (percent >= 0.3) return 'Elementary';
    return 'Beginner';
  }
  ...
  void _answer(String selectedAnswer) {
    ...
    if (isLastQuestion) {
      final resultLevel = _calculateLevel();

      Navigator.pop<String>(context, resultLevel);
      return;
    }
